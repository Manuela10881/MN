...
<body>
  ...
  <section class="banner">
    <h2 class="banner__titulo">Vamos ler um pouco hoje?</h2>
    <p class="banner__texto">Encontre em nossa estante o seu livro do dia!</p>
    <input type="search" class="banner__pesquisa" placeholder="Qual será sua próxima leitura?">
  </section>

  <section class="carrossel">
    <h2 class="carrossel__titulo">LIVROS NOVOS</h2>
    ...
    <div class="card">
      <div class="card__descrição">
        <div class="descrição">
          ...
          <h2 class="descrição__titulo-livro">Nossos livros de romance</h2>
    ...
    <div class="card">
      ...
      <div class="card__descrição">
        ...
        <div class="descrição">
          ...
          <h2 class="descrição__titulo-livro">Manuela Migano</h2>
          <p class="descrição__texto">Especialista em romance é terror .
          </p>
        </div>
        <!-- 2º coluna -->
      ...
      <div class="card__botões">
        ...
        <!-- 2º coluna -->
        <a href="#" class="botões__ancora">Venha buscar mais informações</a>
      </div>
    </div>
  ...
  <section class="tópicos">
    <h2 class="tópicos__titulo">LIVROS MAIS PROCURADOS</h2>
  ...
  <section class="contato">
    <h2 class="contato__titulo">fique por dentro do nosso mundo!</h2>
    <p class="contato__texto">
      Livro novos toda semana é promoções.
    </p>
  ...
  <footer class="rodapé">
    <h2 class="rodapé__titulo">Book Group</h2>
  </footer>
